                  ...
                  <div class="food-type-filter">
                     ...
                     <div class="widget woocommerce widget_layered_nav">
                        <ul>
                           ...
                           <li class="wc-layered-nav-term "><a href=""><?php echo $card->SingleSubCategoryView($SubCategory_id); ?></a> <span class="food-type-icon"><i class="fa fa-cutlery"></i></span></li>
                        </ul>
                     </div>
                  ...
                  <main id="main" class="site-main">
                     <div class="columns-4">
                        <ul class="products">
                            <?php 
                            $s=1;
                            $subProduct = $product->SubCategoryProduct($SubCategory_id);
                            while($fetchProduct = mysql_fetch_array($subProduct)){
