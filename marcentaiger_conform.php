...
?>
<div class="box3">
    <div class="title">Conform Merchant Registration Show </div>
    ...
    <div class="box4"> View New Merchant  <hr> 
        <table class="category-show-tb table">
            ...
            <?php
            include 'db_config.php';
            $select = mysql_query("SELECT * FROM admin where type = '1' && aprove='1' order by admin_id DESC");
            $i = 1;
            while ($fetch_brand = mysql_fetch_array($select)) {
                ...
                <tr>
                    ...
                    <td><a href="delete.php?reg_unconform=<?php echo $fetch_brand['admin_id']; ?>"><img src="icon/confor.png" width="40" height="50"></a></td>
